...
export const agentsApi = {
  ...
  generateInstructions: (
    companyId: string,
    data: { description: string; agentName: string; projectGoal?: string },
  ) =>
    api.post<{ instructions: string }>(
      `/companies/${encodeURIComponent(companyId)}/agents/generate-instructions`,
      data,
    ),
};
